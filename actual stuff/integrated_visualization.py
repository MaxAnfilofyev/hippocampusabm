...
plot_df = df[df['Years'] <= 20]  # <--- Changed from 10 to 20
...
axes[2].set_ylim(-5, 30) # Increased Y-limit slightly for 20-year range

plt.suptitle("AD Progression Model: Amyloid, Inflammation, & Degeneration (0-20 Years)", fontsize=20)
axes[0].legend(title="APOE Genotype")
plt.tight_layout()

# 4. PRINT SLOPES
print("\n--- ATROPHY RATES (Calculated over 20 Years) ---")
